...
native.gsl_sf_airy_Ai_deriv_scaled.argtypes = (c_double, gsl_mode_t)
native.gsl_sf_airy_Ai_deriv_scaled.restype = c_double

def Ai_deriv(x, precision=Mode.default, scaled=False):
    """The derivative of the Airy function."""
    return (native.gsl_sf_airy_Ai_deriv_scaled(x, precision) if scaled else
            native.gsl_sf_airy_Ai_deriv(x, precision))

native.gsl_sf_airy_Ai_deriv_e.argtypes = (c_double, gsl_mode_t, sf_result_p)
native.gsl_sf_airy_Ai_deriv_e.restype = c_int
native.gsl_sf_airy_Ai_deriv_e.errcheck = sf_error_handler
native.gsl_sf_airy_Ai_deriv_scaled_e.argtypes = (c_double, gsl_mode_t,
                                                 sf_result_p)
native.gsl_sf_airy_Ai_deriv_scaled_e.restype = c_int
native.gsl_sf_airy_Ai_deriv_scaled_e.errcheck = sf_error_handler
...
native.gsl_sf_airy_Bi_deriv_scaled.argtypes = (c_double, gsl_mode_t)
native.gsl_sf_airy_Bi_deriv_scaled.restype = c_double

def Bi_deriv(x, precision=Mode.default, scaled=False):
    """The derivative of the Bairy function."""
    return (native.gsl_sf_airy_Bi_deriv_scaled(x, precision) if scaled else
            native.gsl_sf_airy_Bi_deriv(x, precision))

native.gsl_sf_airy_Bi_deriv_e.argtypes = (c_double, gsl_mode_t, sf_result_p)
native.gsl_sf_airy_Bi_deriv_e.restype = c_int
native.gsl_sf_airy_Bi_deriv_e.errcheck = sf_error_handler
native.gsl_sf_airy_Bi_deriv_scaled_e.argtypes = (c_double, gsl_mode_t,
                                                 sf_result_p)
native.gsl_sf_airy_Bi_deriv_scaled_e.restype = c_int
native.gsl_sf_airy_Bi_deriv_scaled_e.errcheck = sf_error_handler
